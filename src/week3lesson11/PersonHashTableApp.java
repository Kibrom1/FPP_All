...
import java.util.Scanner;
 ...
 class PersonItem {
	private String id; // data item (key)
	private String name;

	// --------------------------------------------------------------
	public PersonItem(String id, String name) // constructor
	{
		this.id = id;
		this.name = name;
	}
...
class PersonHashTable {
	...
	public PersonHashTable(int size) // constructor
	{
		arraySize = size;
...
public class PersonHashTableApp {
	public static void main(String[] args) throws IOException {
		...
		theHashTable.insert("Fundamental", "FPP");
		theHashTable.insert("Java", "Java");
		theHashTable.insert("Software", "SE");
		theHashTable.insert("C sharp", "C#");
